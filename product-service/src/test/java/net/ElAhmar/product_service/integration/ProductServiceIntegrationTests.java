package net.ElAhmar.product_service.integration;
...
class ProductServiceIntegrationTests {
	...
	static void setProperties(DynamicPropertyRegistry registrar) {
		registrar.add("spring.data.mongodb.uri", mongoDBContainer::getReplicaSetUrl);
	}
